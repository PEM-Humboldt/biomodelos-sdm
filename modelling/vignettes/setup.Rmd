...
[ENGLISH](https://biomodelos.github.io/tallerNatGeo/setup.html) [![ENGLISH](./images/ENG.png "ENGLISH")](https://biomodelos.github.io/tallerNatGeo/setup.html) |  [SPANISH](https://biomodelos-github-io.translate.goog/tallerNatGeo/setup.html?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=en-US&_x_tr_pto=wapp)  [![SPANISH](./images/ESP.png "SPANISH")](https://biomodelos-github-io.translate.goog/tallerNatGeo/setup.html?_x_tr_sl=en&_x_tr_tl=es&_x_tr_hl=en-US&_x_tr_pto=wapp)
...
* [R](https://cran.r-project.org/bin/windows/base/old/) version 4.1.0 to 4.2.3 (4.3 or upper doesn't work, yet)
...
A guide to install R and R Studio (in spanish) can be found [here](https://docs.google.com/document/d/12dfUggqrRryTJ9zvKJVuFIcl1RT-IwRn/edit?usp=sharing&ouid=110336385847508729052&rtpof=true&sd=true)
